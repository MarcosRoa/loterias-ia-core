...
export class SpecialistEngine extends BaseEngine {
    ...
    gerarJogos(quantidade: number, seed: number, params: any = {}): EngineResult {
        ...
        // Gerar mais jogos do que o necessário para selecionar os melhores
        ...
        for (let i = 0; i < candidatos; i++) {
            ...
            const score = this.evaluator.avaliarJogo(numeros, this.dados);
            candidatosList.push({ numeros, score });
        }
